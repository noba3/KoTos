...
icon = xbmc.translatePath("special://home/addons/plugin.program.iptvxtra-as/icon.png")
from_x = xbmc.translatePath("special://home/addons/plugin.program.iptvxtra-as/resources/advancedsettings.xml")
